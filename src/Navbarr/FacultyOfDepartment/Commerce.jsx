...
function Commerce() {
  return (
    <>
      ...
      <Navbarcontanct /> <br />
      <h2 style={{ marginTop: "30px", fontWeight: 'bolder' }}> | Commerce</h2> <br /><br />
      <h3 style={{textAlign:"center", textDecoration:"underline"}}><b>/ Faculty of Commerce /</b></h3> <br/>
      <h4 style={{ textAlign: "center",  color: "#800080" }}><b>M.Com.</b></h4>
      ...
      <h4 style={{ textAlign: "center",  color: "#800080" }}><b>B.Com</b></h4>
      <div className="tabulka-container" lang="sk">
        <table itemScope="" itemType="http://schema.org/Product">
          {/* Popis tabuľky */}
          {/* Nadradené a podradené záhlavie */}
