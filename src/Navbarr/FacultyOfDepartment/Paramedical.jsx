...
function Paramedical() {
  return (
    <>
      ...
      <Navbarcontanct /> <br /> 
      <h2 style={{ marginTop: "30px", fontWeight: 'bolder' }}> | Paramedical</h2> <br />
      <h3 style={{textAlign:"center", textDecoration:"underline"}}><b>/ Paramedical /</b></h3> <br/>
