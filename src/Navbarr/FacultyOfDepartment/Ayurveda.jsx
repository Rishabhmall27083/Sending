...
function Ayurveda() {
  return (
    <>
      ...
      <Navbarcontanct /> <br /> 
      <h2 style={{ marginTop: "30px", fontWeight: 'bolder' }}> | Ayurveda</h2> <br />
      <h3 style={{textAlign:"center", textDecoration:"underline"}}><b>/ Faculty of Ayurveda/</b></h3> <br/>
      <h5 style={{ textAlign: "center", textDecoration: "underline", color: "#800080" }}><b>INSTITUTE NAME : School of Ayurveda & Siddha Studies </b></h5><br />
