...
function Design() {
  return (
    <>
      ...
      <Navbarcontanct /> <br />
      <h2 style={{ marginTop: "30px", fontWeight: 'bolder' }}> | Design</h2> <br /><br />
      <h3 style={{textAlign:"center", textDecoration:"underline"}}><b>/ Design /</b></h3> <br/>
      <h5 style={{ textAlign: "center", textDecoration: "underline", color: "#800080" }}><b>INSTITUTE NAME:  SCHOOL OF DESIGN</b></h5><br />
