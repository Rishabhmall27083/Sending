...
function Library() {
  return (
    ...
    <h2 style={{marginTop:"30px",fontWeight:'bolder'}}> |  Library</h2><br/>
     <h4 style={{color:"#800080",textAlign:"center", marginTop:"50px",textDecoration:"underline"}}> <b>Library</b></h4> <br/>
