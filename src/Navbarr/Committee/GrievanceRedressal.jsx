...
function GrievanceRedressal() {
  return (
    <>
      ...
      <Navbarcontanct /> <br />
      <h2 style={{ marginTop: "30px", fontWeight: 'bolder' }}>| Grievance Redressal</h2> <br /><br />
      {/* <h3 style={{textAlign:"center", textDecoration:"underline"}}><b>/ Faculty of Management /</b></h3> <br/> */}
      <h5 style={{ textAlign: "center", textDecoration: "underline", color: "#800080" }}><b>CONSTITUTION OF GRIEVANCE REDRESSAL COMMITTEE</b></h5><br />
      <div className="tabulka-container" lang="sk">
        <table itemScope="" itemType="http://schema.org/Product">
          ...
          <tbody>
            ...
            <th scope="row" id="smartfony" itemProp="name">
            Asstt Registrar - Non Teaching Member
              </th>
            </tr>
            </tbody>
        </table>
