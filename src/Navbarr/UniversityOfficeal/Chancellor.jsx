...
import SiddharthKapoor from "../../images/sid.jpg"
...
<h2 style={{marginTop:"30px",fontWeight:'bolder',marginLeft:'80px',marginRight:"40px"}}> | Chancellor of SSSUTMS</h2>
   <br></br>
...
>
  <main className="main-grid" style={{ marginTop: "20px" }}>
    ...
    <div className="main-text" style={{ padding: '20px' }}>
      <h3 className="section-title" style={{ marginTop: "20px" }}> <b>Chancellor</b></h3> <br/>
      <p style={{ color: " #003366" }}>
