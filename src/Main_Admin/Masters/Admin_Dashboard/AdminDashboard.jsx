        ...
        <div className="sidebar close">
          <ul className="nav-links" style={{ marginTop: "30px" }}>
            ...
            <li>
              ...
              <ul className="sub-menu blank" style={{ marginTop: "250px" }}>
            ...
            <li>
              ...
              <ul className="sub-menu" style={{ marginTop: "-350px" }}>
                <li>
                  <a className="link_name" href="#">
                    Accounts
                  </a>
            ...
            <li>
              <a href="#">
                ...
                <img
                  src="https://logoarena-storage.s3.amazonaws.com/contests/public/2938/4542_1369383956_logoaccountsmadeeasy01.jpg"
                  style={{
                    width: "27px",
                    marginLeft: "25px",
                    marginTop: "20px",
              ...
              <ul className="sub-menu blank" style={{ marginTop: "-150px" }}>
                ...
                <div class="scrollable-list-container">
                  <ul>
                    <Link to="/centeralloc">
                      <li>
                        <h6>Course Wise Center Allocation</h6>
                      </li>
                    </Link>
                  </ul>
                  <ul>
                    <Link to="/subjectmaster">  <li>
                      <a href="#">Subject Master & Paper Master</a>
                    </li></Link>
                    <li>
                    ...
                    <li>
                      <a href="#">Date Wise Student Strength(Exam)</a>
                    </li>
                    <li>
            ...
            <li>
              ...
              <ul className="sub-menu blank" style={{ marginTop: "-100px" }}>
                ...
                <div class="scrollable-list-container">
                  <ul>
                    <li>
                      <a href="#">Password View</a>
                    </li>
                    <li>
                      <a href="#">Otp Verification</a>
                    </li>
                    <li>
                      <a href="#">Bonafide Cretificate </a>
                    </li>
                    <li>
