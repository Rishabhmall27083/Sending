...
const Admissionstatus = () => {
    const [admissionSession, setSession] = useState(''); // Add statefor selected session
    const [courseType, setCourseType] = useState(''); // Add state forselected course type
    const [courseName, setCourse] = useState(''); // Add state forselected course
    const [courseBranch, setBranch] = useState(''); // Add state forselected branch
                        ...
                        <div className="shadow-box">
                            ...
                            <div className="scroll-container" style={{ height: "520px" }}>
                                <form style={{ padding: "30px" }}>
                                    ...
                                    <br></br>
                                    <Link
                                        to={`/sea/${admissionSession}/${courseType}/${courseName}/${courseBranch}`}
                                    >
                                        <Button
                                            style={{
                                                marginLeft: "50px",
