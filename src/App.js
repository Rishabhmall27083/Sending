...
import SubjectMaster from "./Main_Admin/Masters/Admin_Dashboard/SubjectMaster.jsx";
import Sub from "./Main_Admin/Masters/Admin_Dashboard/Sub.jsx";
    ...
    <>
      ...
      <Route path="/refound-cancellation" element={<RefoundCancellation/>} />
        ...
        <Route path="/paymen" element={<Paymen />} />
         ...
         <Route path="/subjectm/:session/:courseType/:course/:branch/:college" element={<Sub />} />
        {/* ======================================================= */}
