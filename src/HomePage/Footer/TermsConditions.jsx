        ...
        `}
          ...
          padding: '1em',
                ...
                <h3 className="primary-heading" style={{ color: "black" ,marginBottom:"30px",textDecoration:"underline",marginTop:"20px"}}>
                  SSSUTMS UNIVERSITY Terms & Condition
                </h3>
                ...
                <p className="paragraph" style={{color:"black"}}>
                    ...
                    <br /> <br />
                    6) All trade marks reproduced in this website which are not the
                    property of, or licensed to, the operator are acknowledged on the
                    website.
                    <br /> <br />
                    7) Unauthorised use of this website may give rise to a claim for
                    damages and/or be a criminal offence.
                    <br /> <br />
                    8) From time to time this website may also include links to other
                    websites. These links are provided for your convenience to provide
                    further information. They do not signify that we endorse the
                    website(s). We have no responsibility for the content of the linked
                    website(s).
                    <br /> <br />
                    9) You may not create a link to this website from another website or
                    document without our prior written consent.
                    <br /> <br />
                    10) Your use of this website and any dispute arising out of such use
                    of the website is subject to the laws of India and shall fall under
                    the jurisdiction of the Courts of Madhya Pradesh(Bhopal), India.
                    <br /> <br />
                </p>
            </div>
          <FooterContanct />
