...
const Website = () => {
  ...
  return (
   ...
   <menu className="top_menu flex">
        ...
        <section className="flex_content"></section>
      </menu>
        ...
        <section className="flex_content">
          <figure className="logo fixed_flex">
            <img
              src={logo} alt="" />
            <figcaption>
              <strong className="title">Sri Satya Sai </strong> University of Technology & Medical Sciences
            </figcaption>
          </figure>
        </section>
      ...
      <header className="custom-header">
        <article>
          <h1 className="title big">
            Welcome to <br />
            <em>Sri Satya Sai</em> University of Technology & Medical Sciences
          </h1>
          <p>
